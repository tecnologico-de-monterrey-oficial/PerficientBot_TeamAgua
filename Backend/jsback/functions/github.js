...
async function githubDecisionClassification(responseOpenAI, input) {
  ...
  switch (responseOpenAI) {
    ...
    case 1:
      const response1 = await axios.get('https://perficient-bot-service-backend-flask-dannyjr08.cloud.okteto.net/Github/Repositories').then(async response1 => {
    ...
    case 2:
      const response2 = await axios.get(`https://perficient-bot-service-backend-flask-dannyjr08.cloud.okteto.net/Github/Issues`).then(async response2 => {
    ...
    case 3:
      const response3 = await axios.get(`https://perficient-bot-service-backend-flask-dannyjr08.cloud.okteto.net/Github/Pulls`).then(async response3 => {
